...
var GOODS = {
  ...
  tin: {
    name: 'Олово',
    name_gen: 'олова',
    base_price: 80,   // редкий импорт из Британии через Карфаген
    price_elasticity: 0.8,
    price_floor: 24,
    unit: 'кг',
    category: 'metal',
  ...
  amber: {
    ...
    name_gen: 'янтаря',
    base_price: 200,
    price_elasticity: 0.5,   // люкс — богатые платят любую цену
    price_floor: 60,
    unit: 'кг',
    category: 'luxury',
    resource_type: 'import_only',   // янтарный путь: Балтика → Дунай → Средиземноморье
    deposit_key: null,
    requires_building: null,
    is_food: false,
    is_grain: false,
  ...
  furs: {
    ...
    unit: 'кг',
    category: 'luxury',
    resource_type: 'import_only',   // Галлия, Германия, Скифия, Дакия
    deposit_key: null,
    requires_building: null,
    is_food: false,
    is_grain: false,
  ...
  incense: {
    ...
    unit: 'амфора',
    category: 'luxury',
    resource_type: 'import_only',   // Аравия Феликс, Сомали — маршрут через Египет
    deposit_key: null,
    requires_building: null,
    is_food: false,
    is_grain: false,
