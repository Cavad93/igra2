...
var GOODS = {
  ...
  //
  // base_price пшеницы = 10 — политическое решение, задающее масштаб:
  //   1 золотой (aureus) = 0,1 бушеля ≈ 3 кг зерна
  //   Исторически: 1 денарий ≈ 1 модий ≈ 6,5 кг → aureus ≈ 2 денариям.
  //
