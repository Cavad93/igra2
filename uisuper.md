...
## ЭТАП 14 — Статус-бар: убрать FPS и дебаг из UI
...
## ЭТАП 15 — Аквидукт: разметка и CSS радиального виджета
...
## ЭТАП 16 — Аквидукт: частицы и подключение к данным
...
## ЭТАП 17 — Карта: стиль Tabula Peutingeriana
...
## ЭТАП 18 — Карта: армии-орлы, города, сезонный оверлей
...
## ЭТАП 19 — Роза ветров: разметка и CSS
...
## ЭТАП 20 — Роза ветров: JS переключения режимов
...
## ЭТАП 21 — Диптих: разметка и CSS складной левой панели
...
## ЭТАП 25 — Табличка-лог: разметка и CSS
...
## ЭТАП 26 — Табличка-лог: JS и стиль манускрипта
...
## ЭТАП 27 — Строка команды: разметка и CSS вощёной дощечки
...
## ЭТАП 31 — Рефакторинг: аудит `index.html` и карта содержимого
...
## ЭТАП 32 — Рефакторинг: вынос базового CSS в `ui/styles/base.css`
...
## ЭТАП 33 — Рефакторинг: вынос CSS верхнего слоя в `ui/styles/top.css`
...
## ЭТАП 34 — Рефакторинг: вынос CSS сплэша в `ui/styles/splash.css`
...
## ЭТАП 35 — Рефакторинг: вынос CSS панелей в `ui/styles/panels.css`
...
## ЭТАП 36 — Рефакторинг: вынос CSS нижней зоны в `ui/styles/bottom.css`
...
## ЭТАП 41 — Рефакторинг: вынос обработчиков топ-бара в `ui/top_bar.js`
...
## ЭТАП 42 — Рефакторинг: вынос «монтажного листа» в `ui/boot.js`
...
## ЭТАП 43 — Рефакторинг: финальный аудит и полный smoke-тест
