...
export var PLAIN_MIN = 0.35;
export var PLAIN_MAX = 0.60;
 ...
 */
export function generateKeyPoints(heightmap, count, seed) {
...
// ══════════════════════════════════════════════════════════════
export function BinaryHeap(scoreFn) {
  this.items = [];
...
// ────────────────────────────────────────────────────────────────
export function astar(heightmap, start, end) {
  if (!heightmap || !heightmap.data) return [];
  if (!start || !end) return [];
...
// ────────────────────────────────────────────────────────────────
export function generateRoads(heightmap, keyPoints) {
  if (!heightmap || !heightmap.data) return [];
