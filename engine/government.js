...
Стабильность −25, легитимность −20. Немедленно назначьте наследника!`,
  ...
  // Флаг смены правителя для системы итогов правления
  if (isPlayer) {
    gov.ruler_changed = true;
    // Сбросить счётчик регионов gained за правление
    nation._regions_gained_this_reign = 0;
  }
}
