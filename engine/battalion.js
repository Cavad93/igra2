...
(function(root) {
  ...
  var BATTALION_SIDES      = ['ally', 'enemy'];
  var BATTALION_UNIT_TYPES = ['infantry', 'cavalry', 'archers', 'cannon'];
  var BATTALION_FORMATIONS = ['line', 'square', 'skirmish'];
  ...
  var api = {
    Battalion:             Battalion,
    createTestBattalions:  createTestBattalions,
    BATTALION_SIDES:       BATTALION_SIDES,
    BATTALION_UNIT_TYPES:  BATTALION_UNIT_TYPES,
    BATTALION_FORMATIONS:  BATTALION_FORMATIONS
  };
  ...
  if (root) {
    root.Battalion            = Battalion;
    root.createTestBattalions = createTestBattalions;
  }
