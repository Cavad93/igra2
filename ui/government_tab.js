...
function renderGovernmentTab(nation) {
  ...
  // 11. Историческое сравнение (Сессия 9)
  if (typeof renderHistoricalRatingBlock === 'function') {
    sections.push(renderHistoricalRatingBlock(nation));
  }

  // 12. Завещание наследнику (Сессия 10 — только при возрасте >= 60)
  if (typeof renderTestamentBlock === 'function') {
    sections.push(renderTestamentBlock(nation));
  }
